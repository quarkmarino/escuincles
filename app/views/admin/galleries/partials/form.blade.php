...
{{--<div class="content-wrapper clearfix">--}}
	...
	<div class="col-sm-12 col-md-12">
		{{ Form::open( array('route' => 'galleries.store', 'class' => 'form-style validate-form clearfix', 'id' => 'gallery-form', 'role' => 'form') ) }}
			{{--<!-- form top row -->
			<div class="col-md-12">--}}
				<!-- form left col -->
				<div class="col-md-6">
		    ...
		    <!-- form bottom row -->
				<div class="col-md-12">
					<div class="form-group">
						...
						<button type="submit" class="btn btn-sm btn-outline-inverse">Crear Galería</button>
					</div> 
