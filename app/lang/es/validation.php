...
return array(
	...
	*/
	...
	'custom' => array(
		'gallery_id' => array(
			'exists' => 'La galería seleccionada no esta disponible o es invalida.',
			'required' => 'La galería es obligatoria',
		),
		'title' => array(
			'required' => 'El título es obligatorio.',
			'max' => 'El título puede tener como maximo :max caracteres.',
			'min' => 'El título debe ser almenos de :min caracteres.',
			"alpha_spaces" => "El título solo puede contener letras y espacios.",
			"alpha_num_spaces" => "El título solo puede contener letras, numeros y espacios.",
		),
		'name' => array(
		...
		'status' => array(
			...
			"in" => "El estatus solo puede ser visible o no visible.",
		),
		'email' => array(
